...
public class FavorController {
    ...
    @ApiOperation(value = "添加收藏（文章/cos）",notes = "existWrong：cos不存在 repeatWrong：重复收藏 success：成功")
    ...
    @ApiOperation(value = "取消收藏（文章/cos）",notes = "existWrong：cos不存在 repeatWrong：未收藏 success：成功")
    ...
    @ApiOperation(value = "判断cos是否已经收藏",notes = "success：成功 返回data：judgeFavorList（0：未收藏 1：已收藏）")
