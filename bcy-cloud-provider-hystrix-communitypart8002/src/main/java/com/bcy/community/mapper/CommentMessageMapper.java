...
public interface CommentMessageMapper extends BaseMapper<CommentMessage> {
    ...
    @Select("SELECT a.id,a.username,a.photo,b.type,b.cos_or_qa_number,b.type,b.is_read,b.create_time,b.description FROM user as a,comment_message as b WHERE a.id = b.to_id AND b.to_id = #{id} ORDER BY b.create_time")
